...
Source0  : https://download.kde.org/stable/frameworks/5.98/kpty-5.98.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.98/kpty-5.98.0.tar.xz.sig
...
%prep
%setup -q -n kpty-5.98.0
cd %{_builddir}/kpty-5.98.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662991900
mkdir -p clr-build
pushd clr-build
